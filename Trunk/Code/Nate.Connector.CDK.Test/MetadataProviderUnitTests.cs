...
namespace CDK
{
    ...
    public class MetadataProviderUnitTests : ConnectedUnitTestBase
    {
        ...
        {
            var objDef = connector.GetMetadataProvider().RetrieveObjectDefinition("PurchaseOrder_850", true);
        ...
        {
            var objDef = connector.GetMetadataProvider().RetrieveObjectDefinition("PurchaseOrder_850", false);
