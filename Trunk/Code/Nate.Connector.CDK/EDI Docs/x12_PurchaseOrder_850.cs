...
{
    [ObjectDefinition(Hidden = false, Name = EntityNames.X12_PurchaseOrder_850)]
    [CreateWith]
    [Query]
    public class PurchaseOrder_850
    {
        ...
        #endregion
        [PropertyDefinition(Name = EntityNames.X12_PurchaseOrder_Groups)]
        public List<FunctionalGroup> Groups { get; set; }

        [ObjectDefinition(Name = EntityNames.X12_PurchaseOrder_Groups)]
        [EdiGroup]
        ...
        public class Order
        {
            ...
            [PropertyDefinition(Name = EntityNames.X12_PurchaseOrder_Address)]
            public List<Address> Addresses { get; set; }

            [PropertyDefinition(Name = EntityNames.X12_PurchaseOrder_Details)]
        ...
        [ObjectDefinition(Name = EntityNames.X12_PurchaseOrder_Details)]
        ...
        public class OrderDetail
        {
            ...
            [PropertyDefinition(Name = EntityNames.X12_PurchaseOrder_MSG)]
            public List<MSG> MSG { get; set; }

        }

        [ObjectDefinition(Name = EntityNames.X12_PurchaseOrder_Address)]
        ...
        [ObjectDefinition(Name = EntityNames.X12_PurchaseOrder_MSG)]
