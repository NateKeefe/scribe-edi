...
{
    [ObjectDefinition(Hidden = false, Name = EntityNames.X12_Invoice_810)]
    [CreateWith]
    [Query]
    public class Invoice_810
    {
        ...
        [PropertyDefinition(Name = EntityNames.X12_Invoice_Groups)]
        public List<FunctionalGroup> Groups { get; set; }

        [ObjectDefinition(Name = EntityNames.X12_Invoice_Groups)]
        [EdiGroup]
